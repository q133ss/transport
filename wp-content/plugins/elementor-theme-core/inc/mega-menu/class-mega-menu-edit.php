...
//    private $extra_menu= $extra_menu_custom;
    ...
    <?php if (0 === $depth && $check_mega && $enable_megamenu === true) : ?>
        <p class="description description-wide">
            <label for="edit-menu-item-cms-megaprofile-<?php echo esc_attr($item_id); ?>">
                <?php esc_html_e('Select Mega Menu', ETC_TEXT_DOMAIN); ?><br/>
                <select id="edit-menu-item-cms-megaprofile-<?php echo esc_attr($item_id); ?>" class="widefat"
                    ...
                    <option value="0"><?php esc_html_e('None', ETC_TEXT_DOMAIN) ?></option>
                    <?php
                    $r = $this->walker_args;
    ...
    <?php //if ($check_mega): ?>
        <p class="description description-wide">
            <label for="edit-menu-item-cms-icon-<?php echo esc_attr($item_id); ?>">
                <?php esc_html_e('Icon', ETC_TEXT_DOMAIN); ?><br/>
                <select id="edit-menu-item-cms-icon-<?php echo esc_attr($item_id); ?>"
                    ...
                    <option value="" <?php selected('', esc_attr($item->cms_icon)) ?>><?php esc_html_e('No Icons', ETC_TEXT_DOMAIN) ?></option>
    ...
    <?php if ($enable_ongpage_option && 0 === $depth) : ?>
        <p class="description description-wide">
            <label for="menu-item-cms-onepage-<?php echo esc_attr($item_id); ?>">
                <?php esc_html_e('One page', ETC_TEXT_DOMAIN); ?><br/>
                <select id="menu-item-cms-onepage-<?php echo esc_attr($item_id); ?>"
                    ...
                    <option value="no-one-page" <?php selected(esc_attr($item->cms_onepage), 'no-one-page') ?>><?php esc_html_e('No', ETC_TEXT_DOMAIN) ?></option>
                    <option value="is-one-page" <?php selected(esc_attr($item->cms_onepage), 'is-one-page') ?>><?php esc_html_e('Yes', ETC_TEXT_DOMAIN) ?></option>
                </select>
            </label>
        </p>
        <p class="description description-wide">
            <label for="menu-item-cms-onepage-offset-<?php echo esc_attr($item_id); ?>">
                <?php esc_html_e('One page offset', ETC_TEXT_DOMAIN); ?><br/>
                <input type="number" min="0" id="menu-item-cms-onepage-offset-<?php echo esc_attr($item_id); ?>"
                        class="widefat menu-item-cms-onepage-offset"
                        name="menu-item-cms-onepage-offset[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr($item->cms_onepage_offset); ?>" />
            </label>
        </p>
    <?php endif;
    ...
    function cms_iconpicker_fontawesome()
    {
        ...
        $icons = apply_filters("cms_mega_menu/get_icons", $icons);

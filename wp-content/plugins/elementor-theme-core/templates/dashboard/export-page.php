...
<div class="abcore-export-demos">
    <h2><?php echo esc_html__('Export', ETC_TEXT_DOMAIN) ?></h2>
    <form method="post" class="abcore-export-contents">
        <div class="abcore-export-name">
            <label for="abcore-ie-id">
                <h4><?php echo esc_html__('Demo Name (*) Enter demo slug (EXP : demo1, demo_1, demo-1...)', ETC_TEXT_DOMAIN) ?></h4>
            </label>
        ...
        <div class="abcore-export-link">
            <label for="abcore-ie-link">
                <h4><?php echo esc_html__('Link Demo Preview (*)', ETC_TEXT_DOMAIN) ?></h4>
            </label>
        ...
        <div class="abcore-export-btn">
            ...
            <button type="submit" class="button button-primary create-demo"><?php esc_html_e('Create Demo', ETC_TEXT_DOMAIN); ?></button>
            <button type="button" class="button button-primary download-demo"><?php esc_html_e('Download All Demos', ETC_TEXT_DOMAIN); ?></button>
        </div>
    </form>
</div>

...
etc_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Service Grid', 'equita' ),
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'item_style',
                            'label' => esc_html__('Item Style', 'equita' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => 'box-default',
                            'options' => [
                                'box-default' => esc_html__('Default', 'equita' ),
                                'box-shadow' => esc_html__('Box Shadow', 'equita' ),
                            ],
                        ),
                        array(
                            'name' => 'show_thumbnail',
                        ...
                        array(
                            'name' => 'bg_image',
                            'label' => esc_html__('Item Overlay Image', 'equita'),
